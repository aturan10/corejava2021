...
public class Treeset01 {
	...
	/*
	 * 1)In TreeSet, all elements are unique and in asceding order
	 * 2)TreeSet speds too much time to put the elemants in ascending order, because TreSet is very slow.
