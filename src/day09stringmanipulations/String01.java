...
public class String01 {
	...
	public static void main(String[] args) {
		...
		//15.Method: substring()  <== Used to get a specific part of a String + Return String
		String s1 = "Java is easy";
		
		System.out.println(s1.substring(5, 7));//is <== starting index is inclusive, ending index is exculusive
		
		System.out.println(s1.substring(1, 4));//ava
		
		System.out.println(s1.substring(8, 12));//easy <== There is no index 12 but Java will not work with 12, it will use 11 at the end and index 11 exists
		
		System.out.println(s1.substring(8));//easy <== If you want to get all characters from a specific character to the last character use substring() with a single parameter
		System.out.println(12);//It returns nothing
...
//		System.out.println(s3.substring(5,3));// error Starting index cannot  be greater than ending index
//		System.out.println(a,4);

		/*
		 If you get red underline while you type code, it is called "Compile Time Error"
		 If you get red messages on the console after running your code, it is called "Run Time Error"
		 */
		/*
		...
		//16.Method: trim()  <== Used to remove space character from the beginning and end +Return nothing
