...
/*
	 		1) Arrays are used to store multiple datanin a single container
	 		2) In an array all elements must be in same data type.
	 		3) Arrays accept just "primitives" and "references" as data type,
	 		  you can not store "non-primitive" data types in array theoritecally
...
public class Array01 {
	...
	public static void main(String[] args) {
		...
		//How to print a specific element from anarray
		
		System.out.println(a[2]);//11
		System.out.println(a[4]);//22
		//System.out.println(a[5]);//ArrayIndexOutOfBoundsExpection
		//How to get the number of elements in an array
		//Note: We use "length()" inStrings, but we use "length" in array
