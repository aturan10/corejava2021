...
public class FunctionalPrograming02 {
	/*
	 	Method References: Class Name ::Method Name without method paranhesis
	 	EX==>   		   String     ::  length
	 					   ArrayList  ::  size
	...
	public static void getMinGreaterThanSevenEven1(List<Integer> l) {		
		Integer minEl = l.
						  stream().
						  distinct().
						  filter(t->t>7).filter(Utils::checkToEven).
						  reduce(Integer.MAX_VALUE, Math::min);		
